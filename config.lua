...
state = {
    ...
    automationOverlay = false,
    performanceOverlay = false,

    notifications = false,
    petNotifications = false,
    auraNotifications = false,
    rarityNotifications = false,
...
-- Defaults are intentionally OFF for every feature. Do not restore a previous
-- session automatically; use the UI's save mechanism explicitly instead.
-- loadConfig()
